...
VALUES ('Recursos Humanos', 'FlowManager', NULL),
       ('Sin asignar', 'FlowManager', NULL),
       ('Desarrollo', 'FlowManager', NULL),
       ('Marketing', 'FlowManager', NULL),
       ('Ventas', 'FlowManager', NULL),
       ('Soporte Técnico', 'FlowManager', NULL);
...
INSERT INTO usuarios (Dni, Nombre, Apellido, FechaNacimiento, Domicilio, CorreoElectronico, Telefono, TipoDeUsuario, Departamento, Clave)
